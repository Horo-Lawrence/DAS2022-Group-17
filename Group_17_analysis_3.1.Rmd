...
```{r log-odds, eval = TRUE, out.width='90%', fig.height = 9, fig.width = 15, fig.align = "center", fig.cap ="\\label{fig:mod1logodds} Logodds Plot of Wine Points Above 90 by Prices", fig.pos = "H"}
...
```{r odds, eval = TRUE, out.width='90%', fig.height = 9, fig.width = 15, fig.align = "center", fig.cap = "\\label{fig:mod1odds} Odds Plot of Wine Points Above 90 by Prices", fig.pos = "H"}
