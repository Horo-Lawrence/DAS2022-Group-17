...
# In terms of price, we change the NA to the mean of the price with the same points.
...
```{r class_price_boxplot, eval = TRUE, out.width='100%', fig.height = 3, fig.width = 15, fig.align = "center", fig.cap = "\\label{fig:boxplot} Box Plot of Prices for Wine Classes", fig.pos = "H"}
...
```{r class_country_barchart, eval = TRUE, out.width='100%', fig.height = 9, fig.width = 15, fig.align = "center", fig.cap = "\\label{fig:barchart_1} Bar Plot of Country for Wine Classes", fig.pos = "H"}
wine %>% 
