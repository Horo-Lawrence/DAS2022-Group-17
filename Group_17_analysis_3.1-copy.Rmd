...
Our data contains ratings on a variety of wines and several characteristics about them, which are country, price, province, title, variety, winery. From the data, the titles and winery of different wines vary, which are not very significant for this study, so we study the effects of the remaining variables on the ratings.
...
From the boxplot, it can be found that the wines with prices over 200 are definitely 'Splendid'. Thus we decided to remove some outliers with prices over 200. 
...
#            variety=='Ros<e9>'|variety=='Sangiovese'| variety=='Sauvignon Blanc'| 
#            variety=='Tempranillo'| variety=='White Blend') 
# model_class_country_variety <- glm(as.factor(class) ~ country + variety + price, data=wine_data, family=binomial(link = 'logit'))
